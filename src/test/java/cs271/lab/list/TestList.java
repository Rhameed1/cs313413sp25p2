...
public class TestList {
  ...
  public void setUp() throws Exception {
    ...
    //list = new LinkedList<Integer>();// TODO Question: Also try with a LinkedList - does it make any difference?
  }
  ...
  public void testSizeNonEmpty() {
    ...
    assertEquals(77, list.get(0).intValue()); // added one value 77
  }
